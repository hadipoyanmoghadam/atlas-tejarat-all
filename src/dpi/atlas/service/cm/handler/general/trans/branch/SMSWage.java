 ...
 * Time: 8:40 AM
 */
public class SMSWage extends HostHandlerBase {
    private static Log log = LogFactory.getLog(SMSWage.class);


public HostResultSet _post(Object o, Map map, HostInterface hostInterface) throws CMFault {
    if (log.isInfoEnabled()) log.info("Inside SMSWage:_post()");
   ...
   ref_no = Constants.SPW_FUND_TRANSFER + inputParams.get(Constants.SESSION_ID);
    ...
    inputParams.put(Constants.MESSAGE_TYPE, Constants.WAGE_SMS_TYPE);
