 ...
 * Time: 8:40 AM
 */
public class SMSActive extends HostHandlerBase {
    private static Log log = LogFactory.getLog(SMSActive.class);


    public HostResultSet _post(Object o, Map map, HostInterface hostInterface) throws CMFault {
        if (log.isInfoEnabled()) log.info("Inside SMSActive:_post()");
        ...
        inputParams.put(Constants.MESSAGE_TYPE, Constants.ACTIVE_SMS_TYPE);
