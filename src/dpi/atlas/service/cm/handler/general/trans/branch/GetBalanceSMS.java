...
public class GetBalanceSMS extends HostHandlerBase {
    private static Log log = LogFactory.getLog(GetBalanceSMS.class);
    ...
    public HostResultSet _post(Object o, Map map, HostInterface hostInterface) throws CMFault {
        if (log.isInfoEnabled()) log.info("Inside GetBalanceSMS:_post()");
