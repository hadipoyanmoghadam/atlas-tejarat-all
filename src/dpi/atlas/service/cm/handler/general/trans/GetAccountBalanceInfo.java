...
public class GetAccountBalanceInfo extends HostHandlerBase {
    private static Log log = LogFactory.getLog(GetAccountBalanceInfo.class);
    ...
    public HostResultSet _post(Object o, Map map, HostInterface hostInterface) throws CMFault {
        if (log.isInfoEnabled()) log.info("Inside GetAccountBalanceInfo:_post()");
        ...
        try {
            ...
            hrs = ((HostInterfaceNAB) hostInterface).getAccountBalanceInfo(inputParams);
            if (hrs.next()) {
