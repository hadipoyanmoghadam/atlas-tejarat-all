...
public class GetStatement extends HostHandlerBase {
    ...
    public HostResultSet _post(Object obj, Map holder, HostInterface host) throws CMFault {
        ...
        String acc_no = creditsMessage.getAccountNo();
        String trans_count = command.getParam(Fields.TRANS_COUNT);
        String branchId = command.getParam(Fields.BRANCH_CODE);
        ...
        trans_count = (trans_count != null && trans_count.length() != 0) ? trans_count.substring(2) : "3";
...
//             set available balance
            ...
            if (lastAmount == null || lastAmount.equals(""))
                ...
                row.add(lastAmount);
            row.add(original_res.getString("PAYID1"));
