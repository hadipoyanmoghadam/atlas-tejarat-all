...
public class ManzumeFollowup extends HostHandlerBase {
    ...
    public HostResultSet _post(Object o, Map map, HostInterface hostInterface) throws CMFault {
        ...
        inputParams.put(Constants.ACC_NO, manzumeMessage.getAccountNo());

        String origMessageData =manzumeMessage.getOrigMessageData();
        ...
        inputParams.put(Constants.BRANCH_CODE, manzumeMessage.getBranchCode());
