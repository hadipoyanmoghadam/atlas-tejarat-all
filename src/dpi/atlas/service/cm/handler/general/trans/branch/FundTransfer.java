...
public class FundTransfer extends HostHandlerBase {
    ...
    public HostResultSet _post(Object o, Map map, HostInterface hostInterface) throws CMFault {
        ...
        String date= creditsMessage.getTransDate();
        ...
        inputParams.put(Constants.REF_NO, creditsMessage.getMessageSequence());
        inputParams.put(Constants.AMOUNT, creditsMessage.getAmount());
        inputParams.put(Constants.DATE, date);
        inputParams.put(Constants.TIME, creditsMessage.getTransTime());
        ...
        inputParams.put(Fields.MN_ID, creditsMessage.getId1()!=null ? creditsMessage.getId1().trim() : "");


        HostResultSet hrs;
        HostResultSet hrs_ret = null;
        try {
            hrs = ((HostInterfaceNAB) hostInterface).getBranchDeposit(inputParams);
            if (hrs.next())
