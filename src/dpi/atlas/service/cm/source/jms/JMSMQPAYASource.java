 ...
 * Time: 13:49 PM
 */
public class JMSMQPAYASource extends CMSourceBase {
    private static Log log = LogFactory.getLog(JMSMQPAYASource.class);
    ...
    public void startService() throws Exception {
        ...
        try {
            ...
            JMSMQPAYAListener listener = (JMSMQPAYAListener) Class.forName(qListenerClassName).newInstance();
