...
public class ChannelAdminServlet extends HttpServlet {
    private static Log log = LogFactory.getLog(ChannelAdminServlet.class);


    public void init(ServletConfig servletConfig) throws ServletException {
        super.init(servletConfig);
        if (log.isInfoEnabled()) log.info("inside AdminServlet of Channel::init()");
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            if (log.isInfoEnabled()) log.info("inside AdminServlet of Channel");
            String text = req.getParameter("text");
            if (log.isInfoEnabled()) log.info("general incoming text: " + text);
            ...
            msg.setAttribute(CMMessage.SERVICE_TYPE, "CHADMIN"/*CMMessage.SERVICE_IB*/);
            ...
            msg.setAttribute(Fields.SESSION_ID, "C" + sequenceNumber);

            command.addHeaderParam(Fields.SESSION_ID, "C" + sequenceNumber);
