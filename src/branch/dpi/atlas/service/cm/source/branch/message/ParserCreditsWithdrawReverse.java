 ...
 * Time: 11:00 AM
 */
public class ParserCreditsWithdrawReverse extends CreditsMessage {
    public ParserCreditsWithdrawReverse(String msgStr) throws FormatException {
        super(msgStr);
        if (msgStr.length() == Constants.CREDITS_WITHDRAW_REVERSE_REQUEST_LENGTH)
            unpackBody();
        else
