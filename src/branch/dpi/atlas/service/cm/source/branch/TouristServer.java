 ...
 * Time: 11:43 AM
 */
public class TouristServer extends Observable
        implements Runnable, Observer {
    private static Log log = LogFactory.getLog(TouristServer.class);
    ...
    public TouristServer(int port, BranchServerChannel clientSide, ThreadPool pool) {
        super();
        this.port = port;
    ...
    public TouristServer(int port, BranchServerChannel clientSide, ThreadPoolExecutor pool) {
        super();
        this.port = port;
        this.clientSideChannel = clientSide;
        this.clientSideChannelClass = clientSide.getClass();
                    ...
                    try {
                        ...
                        for (; ; ) {
                            ...
                            if (getIdleCount() == 0 && getActiveCount() >= getMaxPoolSize()) {
                                ...
                                messageString = messageString.substring(0, 58) + ActionCode.TOO_MANY_RECORDS_REQUESTED;
