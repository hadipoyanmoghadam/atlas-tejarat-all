 ...
 * Time: 11:41 AM
 */
public class TouristSource extends CMSourceBase {
    ...
    private TouristServer server;
    TouristListener listener;

    public TouristSource()
            throws Exception {
        this(PORT_DEFAULT);
    }

    public TouristSource(int port)
            throws Exception {
        this.port = port;
    }
    ...
    public void startService()
        ...
        server = new TouristServer(port, (BranchServerChannel) branchChannel, threadPool);

        listener = new TouristListener();
