 ...
 * Time: 10:23 AM
 */
public class ParserReverseDepositATM extends BranchMessage {
    public ParserReverseDepositATM(String msgStr) throws FormatException {
        super(msgStr);
        if (msgStr.length() == Constants.REVERSE_DEPOSIT_ATM_REQUEST_LENGTH)
            unpackBody();
        else
