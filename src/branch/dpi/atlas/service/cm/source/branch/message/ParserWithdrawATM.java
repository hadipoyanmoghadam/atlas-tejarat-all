 ...
 * Time: 10:10 AM
 */
public class ParserWithdrawATM extends BranchMessage {

    public ParserWithdrawATM(String msgStr) throws FormatException {
        super(msgStr);
        if (msgStr.length() == Constants.WITHDRAW_ATM_REQUEST_LENGTH)
            unpackBody();
        else
