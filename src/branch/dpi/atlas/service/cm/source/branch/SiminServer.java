 ...
 * Time: 11:43 AM
 */
public class SiminServer extends Observable
        implements Runnable, Observer {
    private static Log log = LogFactory.getLog(SiminServer.class);
    ...
    public SiminServer(int port, BranchServerChannel clientSide, ThreadPool pool) {
        super();
        this.port = port;
    ...
    public SiminServer(int port, BranchServerChannel clientSide, ThreadPoolExecutor pool) {
        super();
        this.port = port;
        this.clientSideChannel = clientSide;
        this.clientSideChannelClass = clientSide.getClass();
