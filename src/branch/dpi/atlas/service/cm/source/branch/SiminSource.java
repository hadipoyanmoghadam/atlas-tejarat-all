 ...
 * Time: 11:41 AM
 */
public class SiminSource extends CMSourceBase {
    ...
    private SiminServer server;
    SiminListener listener;
    ...
    public void startService()
        ...
        server = new SiminServer(port, (BranchServerChannel) branchChannel, threadPool);

        listener = new SiminListener();
