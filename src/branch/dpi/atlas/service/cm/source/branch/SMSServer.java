 ...
 * Time: 9:42:33 AM
 */
public class SMSServer extends Observable
        implements Runnable, Observer {
    private static Log log = LogFactory.getLog(SMSServer.class);
    ...
    public SMSServer(int port, BranchServerChannel clientSide, ThreadPool pool) {
        super();
        this.port = port;
    ...
    public SMSServer(int port, BranchServerChannel clientSide, ThreadPoolExecutor pool) {
        super();
        this.port = port;
        this.clientSideChannel = clientSide;
        this.clientSideChannelClass = clientSide.getClass();
