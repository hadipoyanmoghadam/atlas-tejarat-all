 ...
 * Time: 10:15 AM
 */
public class CreditsServer extends Observable
        implements Runnable, Observer {
    private static Log log = LogFactory.getLog(CreditsServer.class);
    ...
    public CreditsServer(int port, BranchServerChannel clientSide, ThreadPool pool) {
        super();
        this.port = port;
    ...
    public CreditsServer(int port, BranchServerChannel clientSide, ThreadPoolExecutor pool) {
        super();
        this.port = port;
        this.clientSideChannel = clientSide;
        this.clientSideChannelClass = clientSide.getClass();
                    ...
                    try {
                        ...
                        for (; ; ) {
                            ...
                            if (getIdleCount() == 0 && getActiveCount() >= getMaxPoolSize()) {
                                ...
                                messageString = messageString.substring(0, 70) + ActionCode.TOO_MANY_RECORDS_REQUESTED;
