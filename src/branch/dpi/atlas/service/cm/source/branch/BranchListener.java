 ...
 * Time: 10:45:06 AM
 */
public class BranchListener implements BranchRequestListener {
     private CMHandler cmHandler;
     private static Log log = LogFactory.getLog(BranchListener.class);
     ...
     public boolean process(BranchSource source, String branchMsgStr) {
        ...
        // Parse branchMessageStr
            ...
            msg.setAttribute(CMMessage.SERVICE_TYPE, Constants.BRANCH_SERVICE);
