 ...
 * Time: 10:50 AM
 */
public class ParserCreditsWithdraw extends CreditsMessage {
    public ParserCreditsWithdraw(String msgStr) throws FormatException {
        super(msgStr);
        if (msgStr.length() == Constants.CREDITS_WITHDRAW_REQUEST_LENGTH)
            unpackBody();
        else
