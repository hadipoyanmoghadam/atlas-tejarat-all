 ...
 * Time: 1:37 PM
 */
public class ParserFTSafeBox extends AmxMessage {
    public ParserFTSafeBox(String msgStr) throws FormatException {
        super(msgStr);
        if (msgStr.length() == Constants.FUND_TRANSFER_SAFE_BOX_REQUEST_LENGTH)
            unpackBody();
        else
