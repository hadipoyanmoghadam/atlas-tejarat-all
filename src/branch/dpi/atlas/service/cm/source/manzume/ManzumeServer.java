 ...
 * Time: 9:42:33 AM
 */
public class ManzumeServer extends Observable
        implements Runnable, Observer {
    private static Log log = LogFactory.getLog(ManzumeServer.class);
    ...
    public ManzumeServer(int port, BranchServerChannel clientSide, ThreadPool pool) {
        super();
        this.port = port;
    ...
    public ManzumeServer(int port, BranchServerChannel clientSide, ThreadPoolExecutor pool) {
        super();
        this.port = port;
        this.clientSideChannel = clientSide;
        this.clientSideChannelClass = clientSide.getClass();
                    ...
                    try {
                        ...
                        for (; ; ) {
                            ...
                            if (getIdleCount() == 0 && getActiveCount() >= getMaxPoolSize()) {
                                ...
                                messageString = messageString.substring(0,50) + ActionCode.TOO_MANY_RECORDS_REQUESTED;
