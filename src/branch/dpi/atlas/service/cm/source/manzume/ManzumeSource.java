...
public class ManzumeSource extends CMSourceBase {
    ...
    private ManzumeServer server;
    ManzumeListener listener;

    public ManzumeSource()
            throws Exception {
        this(PORT_DEFAULT);
    }

    public ManzumeSource(int port)
            throws Exception {
        this.port = port;
    }
    ...
    public void startService()
        ...
        server = new ManzumeServer(port, (BranchServerChannel) branchChannel, threadPool);

        listener = new ManzumeListener();
