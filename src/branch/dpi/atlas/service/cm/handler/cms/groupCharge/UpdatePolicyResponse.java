 ...
 * Time: 09:04:03
 */
public class UpdatePolicyResponse extends CMHandlerBase {
    ...
    public void doProcess(CMMessage msg, Map holder) throws CMFault {
        ...
        try {
            ...
            JAXBContext context = JAXBContext.newInstance(UpdatePolicyResp.class);
            Marshaller marshaller = context.createMarshaller();
            marshaller.setProperty(Marshaller.JAXB_ENCODING, "UTF-8");
            marshaller.setProperty(Marshaller.JAXB_FORMATTED_OUTPUT, Boolean.TRUE);
            UpdatePolicyResp policyType = new UpdatePolicyResp();
            ...
            log.error("ERROR :::Inside updatePolicyResponse.doProcess(): " + e.getMessage());
