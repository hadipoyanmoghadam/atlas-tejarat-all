 ...
 * Time: 09:04:03
 */
public class UpdateAllPolicyResponse extends CMHandlerBase {
    ...
    public void doProcess(CMMessage msg, Map holder) throws CMFault {
        ...
        try {
            ...
            JAXBContext context = JAXBContext.newInstance(UpdateAllPolicyResp.class);
            Marshaller marshaller = context.createMarshaller();
            marshaller.setProperty(Marshaller.JAXB_ENCODING, "UTF-8");
            marshaller.setProperty(Marshaller.JAXB_FORMATTED_OUTPUT, Boolean.TRUE);
            UpdateAllPolicyResp policyType = new UpdateAllPolicyResp();
            ...
            log.error("ERROR :::Inside updateAllPolicyResponse.doProcess(): " + e.getMessage());
