 ...
 * Time: 09:04:03
 */
public class PresentationPolicyResponse extends CMHandlerBase {
    ...
    public void doProcess(CMMessage msg, Map holder) throws CMFault {
        ...
        try {
            ...
            JAXBContext context = JAXBContext.newInstance(PresentationPolicyResp.class);
            Marshaller marshaller = context.createMarshaller();
            marshaller.setProperty(Marshaller.JAXB_ENCODING, "UTF-8");
            marshaller.setProperty(Marshaller.JAXB_FORMATTED_OUTPUT, Boolean.TRUE);

            PresentationPolicyResp policyType = new PresentationPolicyResp();
       ...
       if (actionCode.equals(ActionCode.APPROVED)) {
            policyType.setNextDate(policyMsg.getNextDate().trim());
           ...
           policyType.setIntervalType(policyMsg.getIntervalType());
            ...
            log.error("ERROR :::Inside PresentationPolicyResponse.doProcess(): " + e.getMessage());
