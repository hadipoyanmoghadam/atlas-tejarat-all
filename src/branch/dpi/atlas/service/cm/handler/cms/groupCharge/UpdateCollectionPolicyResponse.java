 ...
 * Time: 12:04:03
 */
public class UpdateCollectionPolicyResponse extends CMHandlerBase {
    ...
    public void doProcess(CMMessage msg, Map holder) throws CMFault {
        ...
        try {
            ...
            JAXBContext context = JAXBContext.newInstance(UpdateCollectionPolicyResp.class);
            Marshaller marshaller = context.createMarshaller();
            marshaller.setProperty(Marshaller.JAXB_ENCODING, "UTF-8");
            marshaller.setProperty(Marshaller.JAXB_FORMATTED_OUTPUT, Boolean.TRUE);
            UpdateCollectionPolicyResp policyType = new UpdateCollectionPolicyResp();
            ...
            log.error("ERROR :::Inside UpdateCollectionPolicyResponse.doProcess(): " + e.getMessage());
