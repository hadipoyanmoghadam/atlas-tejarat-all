...
@XmlType(propOrder = {"actioncode", "desc", "rrn", "cardNo", "accountNo", "type", "amount", "startDate", "count", "interval", "intervalType", "respdatetime"})
@XmlRootElement(name = "POLICY_ENDED_PRESENTATION_RESPONSE")
public class PresentationEndedPolicyResp {
