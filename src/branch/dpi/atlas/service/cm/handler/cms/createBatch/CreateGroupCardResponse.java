...
import branch.dpi.atlas.service.cm.handler.cms.groupCharge.CreatePolicyResp;
 ...
 * Time: 09:04:03
 */
public class CreateGroupCardResponse extends CMHandlerBase {
    ...
    public void doProcess(CMMessage msg, Map holder) throws CMFault {
        ...
        try {
            ...
            JAXBContext context = JAXBContext.newInstance(CreateGroupCardResp.class);
            Marshaller marshaller = context.createMarshaller();
            marshaller.setProperty(Marshaller.JAXB_ENCODING, "UTF-8");
            marshaller.setProperty(Marshaller.JAXB_FORMATTED_OUTPUT, Boolean.TRUE);

            CreateGroupCardResp policyType = new CreateGroupCardResp();
            policyType.setActioncode(actionCode);
            policyType.setDesc(actionMsg);
            policyType.setRrn(rrn);
            policyType.setAccountNo(policyMsg.getAccountNo());
            policyType.setCardNo(policyMsg.getCardno());
            ...
            log.error("ERROR :::Inside CreateGroupCardResponse.doProcess(): " + e.getMessage());
