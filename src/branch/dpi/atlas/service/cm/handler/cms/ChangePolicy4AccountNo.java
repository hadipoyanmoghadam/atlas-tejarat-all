 ...
 * Time: 11:04:03
 */
public class ChangePolicy4AccountNo extends CMHandlerBase {
    ...
    public void doProcess(CMMessage msg, Map holder) throws CMFault {
        ...
        try {
            ...
            existPolicy = ChannelFacadeNew.getPolicyByAccountNo(accountNo);
            ...
            ChannelFacadeNew.UpdatePolicy4AccountNo(accountNo, msg.getAttributeAsString(Fields.SESSION_ID), type, startDate, endDate, nextDate, count, amount, interval,intervalType, msg.getAttributeAsString(CMMessage.SERVICE_TYPE));
        } catch (CMFault e) {
            ...
            log.error("ERROR :::Inside ChangePolicy4AccountNo.doProcess(): " + e.getMessage());
