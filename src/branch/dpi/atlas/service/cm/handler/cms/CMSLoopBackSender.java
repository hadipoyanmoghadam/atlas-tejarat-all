 ...
 * Time: 13:36:48
 */
public class CMSLoopBackSender extends CMHandlerBase implements Connector {
    ...
    public void doProcess(CMMessage msg, Map holder) throws CMFault {
        ...
        if (msg.getAttribute(CMMessage.RESPONSE) != null) {
            try {
                ...
                String cmsResponse = msg.getAttributeAsString(CMMessage.RESPONSE);
                source.sendBranch(cmsResponse);
            } catch (IOException e) {
                log.error("***  ***" + e);
