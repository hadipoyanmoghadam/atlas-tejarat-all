...
@XmlType(propOrder = {"actioncode","desc","rrn","cardno","accountno","accountgroup","accounttype","namepersian","familypersian",
        "nationalcode","frgCodecode","fathername","sex","birthdate","idnumber","issueplace","mobileno","cardtype","branchCode","respdatetime"})
@XmlRootElement(name = "CARDINFO_RESPONSE")
