package branch.dpi.atlas.service.cm.handler.host.tj;
 ...
 * Time: 16:49 PM
 */
public class BranchHostPostHandler extends TJServiceHandler implements Configurable {
    ...
    public void doProcess(CMMessage msg, Map holder) throws CMFault {
        ...
        try {
            initInputParams(msg);
            if(msg.getAttributeAsString(CMMessage.SERVICE_TYPE)!=null &&  msg.getAttributeAsString(CMMessage.SERVICE_TYPE).equalsIgnoreCase(Fields.SERVICE_PG)){
