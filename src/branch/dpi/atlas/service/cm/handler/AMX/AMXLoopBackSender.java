 ...
 * Time: 04:11 PM
 */
public class AMXLoopBackSender extends CMHandlerBase implements Connector {
    ...
    public void doProcess(CMMessage msg, Map holder) throws CMFault {
        ...
        if (msg.getAttribute(CMMessage.RESPONSE) != null) {
            try {
                ...
                String amxResponse = msg.getAttributeAsString(CMMessage.RESPONSE);
                source.sendBranch(amxResponse);
            } catch (IOException e) {
                log.error("***  ***" + e);
