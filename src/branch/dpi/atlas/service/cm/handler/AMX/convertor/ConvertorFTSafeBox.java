 ...
 * Time: 1:59 PM
 */
public class ConvertorFTSafeBox extends AmxBaseConvertor implements AmxToIMFFormater {
    ...
    public CMCommand format(AmxMessage amxMessage) {
        ...
        if (amxMessage.getTerminalId().equalsIgnoreCase(Constants.TERMINAL_ID_SAFE_BOX))
            command.setCommandName(TJCommand.CMD_FUND_TRANSFER_SAFE_BOX);
        else
            command.setCommandName(TJCommand.CMD_FUND_TRANSFER_MARHOONAT_INSURANCE);
