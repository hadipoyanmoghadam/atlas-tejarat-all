...
public class CheckTransaction4CreditsFollowUp extends TJServiceHandler implements Configurable {

    public void doProcess(CMMessage msg, Map holder) throws CMFault {

        CreditsMessage creditsMessage= (CreditsMessage) msg.getAttribute(CMMessage.COMMAND_OBJ);
        if (!creditsMessage.getPin().equalsIgnoreCase(Constants.PIN_CREDITS_FOLLOWUP))
            return;
