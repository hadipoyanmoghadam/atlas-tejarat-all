 ...
 * Time: 03:41 PM
 */
public class ConvertorCreditsDepositReverse extends CreditsBaseConvertor implements CreditsToIMFFormater {
    @Override
    public CMCommand format(CreditsMessage creditsMessage) {
        ...
        command.setCommandName(TJCommand.CMD_CREDITS_DEPOSIT_REVERSAL);
