 ...
 * Time: 03:24 PM
 */
public class ConvertorCreditsWithdrawReverse extends CreditsBaseConvertor implements CreditsToIMFFormater {
    @Override
    public CMCommand format(CreditsMessage creditsMessage) {
        ...
        command.setCommandName(TJCommand.CMD_CREDITS_WITHDRAW_REVERSAL);
