...
public class CheckCustomerAccount extends TJServiceHandler implements Configurable {
    ...
    private void checkCustomerAccount(CMMessage msg, String accountNo, String pin) throws Exception {
        ...
        if (pin.equals(Constants.PIN_CREDITS_WITHDRAW) || pin.equals(Constants.PIN_CREDITS_DEPOSIT_REVERSE)) {
        ...
        } else if (pin.equals(Constants.PIN_CREDITS_DEPOSIT) || pin.equals(Constants.PIN_CREDITS_WITHDRAW_REVERSE)) {
