 ...
 * Time: 04:14 PM
 */
public class CreditsLoopBackSender extends CMHandlerBase implements Connector {
    ...
    public void doProcess(CMMessage msg, Map holder) throws CMFault {
        ...
        if (msg.getAttribute(CMMessage.RESPONSE) != null) {
            try {
                ...
                String creditsResponse = msg.getAttributeAsString(CMMessage.RESPONSE);
                source.sendBranch(creditsResponse);
            } catch (IOException e) {
                log.error("***  ***" + e);
