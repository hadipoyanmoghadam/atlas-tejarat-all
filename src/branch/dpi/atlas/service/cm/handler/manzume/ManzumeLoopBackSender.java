 ...
 * Time: 9:36:48 AM
 */
public class ManzumeLoopBackSender extends CMHandlerBase implements Connector {
    ...
    public void doProcess(CMMessage msg, Map holder) throws CMFault {
        ...
        if (msg.getAttribute(CMMessage.RESPONSE) != null) {
            try {
                ...
                String manzumeResponse = msg.getAttributeAsString(CMMessage.RESPONSE);
                source.sendBranch(manzumeResponse);
            } catch (IOException e) {
                log.error("***  ***" + e);
