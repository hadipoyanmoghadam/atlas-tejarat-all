...
//        String messageSequence = manzumeMessage.getMessageSequence();
//        boolean isReversed = manzumeMessage.getPin().charAt(2) == '4';
//
//
//        try {
//            String sessionId;
...
//                        String reverse_pin = manzumeMessage.getPin();
//                      if (orig_pin.equals(Constants.PIN_DEPOSIT_MANZUME_RESPONSE) && reverse_pin.equals(Constants.PIN_DEPOSIT_REVERSE_MANZUME)) {
//                            origExist = "1";
//                            sessionId = serviceLogSet.get(0);
//                            String message_id = serviceLogSet.get(1);
//                            int m;
