...
public class ServiceLogger extends TJServiceHandler {
    ...
    public void doProcess(CMMessage msg, Map holder) throws CMFault {
        ...
        String messageSeq = smsMessage.getMessageSequence();
        String txDate = smsMessage.getRequestDate();
        String txTime = smsMessage.getRequestTime();
        String terminalId = "";
        if (smsMessage.getTerminalId() != null)
            terminalId = smsMessage.getTerminalId();

        String cardNo="";
        String accountNo = smsMessage.getAccountNo();

        String txString = smsMessage.getTxString();
        String actionCode = "";
        ...
        try {
            ChannelFacadeNew.insertServiceLog(sessionId, pin, messageId, messageSeq, "", "", txDate,
