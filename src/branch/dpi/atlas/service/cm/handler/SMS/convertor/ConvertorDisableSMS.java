...
public class ConvertorDisableSMS extends SMSBaseConvertor implements SMSToIMFFormater {
    @Override
    public CMCommand format(SMSMessage smsMessage) {
        ...
        command.addParam(Fields.DATE, smsMessage.getRequestDate());
        command.addParam(Fields.TIME, smsMessage.getRequestTime());
        command.addParam(Fields.PAN, Constants.BANKE_TEJARAT_BIN_NEW);
        command.setCommandName(TJCommand.CMD_DISABLE_SMS);
