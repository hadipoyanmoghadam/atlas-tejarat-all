 ...
 * @version $Revision: 1.0 $ $Date: 2019/21/07 12:50:54 $
 */
public class BR_SAFLogHandler implements Configurable {
    private static Log log = LogFactory.getLog(BR_SAFLogHandler.class);

    boolean getFromCash;
    ArrayList do_not_retry_ac = new ArrayList();
    ...
    public String handleCFS(SAFLog safLog) throws Exception {
        ...
        try {
            ...
            if (action_code.startsWith("00")) {
                ...
                Iterator it = do_not_retry_ac.iterator();
                while (it.hasNext()) {
                    String ac = (String) it.next();
                    if (action_code.equals(ac))
                        return "*" + action_code;
                }
                return action_code;
            }
    ...
    public void setConfiguration(Configuration cfg) throws ConfigurationException {
        ...
        String do_not_retry = cfg.get("do-not-retry");
        do_not_retry_ac = CMUtil.tokenizString(do_not_retry, ",");
