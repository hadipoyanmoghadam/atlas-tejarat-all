 ...
 * Time: 10:31 AM
 */
public class ConvertorDepositGiftCardReverse extends BranchBaseConvertor implements BranchToIMFFormater {
    @Override
    public CMCommand format(BranchMessage branchMsg) {
        ...
        command.setCommandName(TJCommand.CMD_BRANCH_DEPOSIT_GIFTCARD_REVERSAL);
        return command;
    }
