 ...
 * Time: 11:33:07 AM
 */
public class ConvertorChangeAccountStatus extends BranchBaseConvertor implements BranchToIMFFormater {
    public CMCommand format(BranchMessage branchMsg) {
        ...
        command.setCommandName(TJCommand.CMD_BRANCH_CHANGE_ACCOUNT_STATUS);
