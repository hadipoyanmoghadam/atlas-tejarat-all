 ...
 * Time: 3:23 PM
 */
public class ConvertorSiminAccountBlockReport extends BranchBaseConvertor implements BranchToIMFFormater {
    ...
    public String createResponse(CMMessage msg, Map map) throws CMFault {
        ...
        try {
            ...
            responseStr.append(ISOUtil.padleft(report.getDesc().trim(), branchMsg.SIMIN_BLOCK_DESCRIPTION, ' '))
