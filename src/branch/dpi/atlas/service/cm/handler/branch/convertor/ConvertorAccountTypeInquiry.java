 ...
 * Time: 2:34 PM
 */
public class ConvertorAccountTypeInquiry extends BranchBaseConvertor implements BranchToIMFFormater {
    ...
    public String createResponse(CMMessage msg, Map holder) throws CMFault {
        try {
            ...
            responseStr.append(branchMsg.getHostID())
                    .append(branchMsg.getIsPoshtiban());
