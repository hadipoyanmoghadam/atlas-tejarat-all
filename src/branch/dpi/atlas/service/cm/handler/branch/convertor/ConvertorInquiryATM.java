 ...
 * Time: 10:51 AM
 */
public class ConvertorInquiryATM extends BranchBaseConvertor implements BranchToIMFFormater {
    ...
    public String createResponse(CMMessage msg, Map map) throws CMFault {
        try {
            ...
            responseStr.append(branchMsg.createResponseHeader())
                    .append(ISOUtil.padleft(branchMsg.getBranchCode(), branchMsg.BRANCH_CODE, '0'))
                    .append(ISOUtil.padleft("0", branchMsg.MAXATM_BALANCE, '0'))
                    .append(ISOUtil.padleft("0", branchMsg.AVGDEFICIT, '0'))
                    .append(ISOUtil.padleft(branchMsg.getBalance(), branchMsg.BALANCE, '0'));
