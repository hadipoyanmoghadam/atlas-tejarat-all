 ...
 * Time: 11:29 AM
 */
public class ConvertorWithdrawGiftCard extends BranchBaseConvertor implements BranchToIMFFormater {
    @Override
    public CMCommand format(BranchMessage branchMsg) {
        ...
        command.addParam(Fields.REQUEST_TYPE, branchMsg.getRequestType());  //REQUEST_TYPE   1:CANCELLATION   2:DISCHARGE
        command.setCommandName(TJCommand.CMD_BRANCH_WITHDRAW_GIFTCARD);
        return command;
    }
