 ...
 * Time: 04:27 PM
 */
public class RemovePayaRequest extends CMHandlerBase {

    public void doProcess(CMMessage msg, Map holder) throws CMFault {

        BranchMessage branchMsg = (BranchMessage) msg.getAttribute(CMMessage.COMMAND_OBJ);
        try {
            ChannelFacadeNew.deletePayaRequest(branchMsg.getBranchCode(),branchMsg.getDocumentNo(),branchMsg.getDueDate());
