 ...
 * Time: 03:48 PM
 */
public class GetPayReport extends CMHandlerBase {

    public void doProcess(CMMessage msg, Map holder) throws CMFault {

        BranchMessage branchMsg = (BranchMessage) msg.getAttribute(CMMessage.COMMAND_OBJ);
        try {
            List<PayaRequest> requestList=ChannelFacadeNew.getPayaReport(branchMsg.getBranchCode(),branchMsg.getFromDate(),branchMsg.getToDate());
