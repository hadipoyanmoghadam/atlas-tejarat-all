...
public class CheckTxExist extends TJServiceHandler {
    ...
    public void doProcess(CMMessage msg, Map holder) throws CMFault {
        ...
        String messageSequence = branchMsg.getMessageSequence();
        boolean isReversed = branchMsg.getPin().charAt(2) == '4';
...
//             if(isReversed)
//             {
//                 String origMessageSequence = branchMsg.getOrigMessageData().substring(0,12);
//                 branchLogSet = ChannelFacadeNew.findBranchLogs(origMessageSequence);
//                 if(branchLogSet.size() > 0)  // Orig Exist
//                 {
//                     origExist = "1";
//                     extractSessionId();
//                 }
//             }
//              branchLogSet = ChannelFacadeNew.findBranchLogs(messageSequence);
...
//                    generateSessionId();
            ...
            branchLogSet = ChannelFacadeNew.findBranchLogs(messageSequence,serviceType);
...
//                extractSessionId();
                ...
                if (isReversed) {
                    String origMessageSequence = branchMsg.getOrigMessageData().substring(0, 12);
                    branchLogSet = ChannelFacadeNew.findBranchLogs(origMessageSequence,serviceType);
                    if (branchLogSet.size() > 0) {
                        String orig_pin = branchLogSet.get(2);
                        String reverse_pin = branchMsg.getPin();
...
//                            extractSessionId();
                        ...
                        } else if (orig_pin.equals(Constants.PIN_DEPOSIT_ATM_RESPONSE) && reverse_pin.equals(Constants.PIN_REVERSE_DEPOSIT_ATM)) {
                            origExist = "1";
//                            extractSessionId();
                            sessionId = branchLogSet.get(0);
                            String message_id = branchLogSet.get(1);
                        ...
                        } else if (orig_pin.equals(Constants.PIN_WITHDRAW_ATM_RESPONSE) && reverse_pin.equals(Constants.PIN_REVERSE_WITHDRAW_ATM)) {
                            origExist = "1";
//                            extractSessionId();
                            sessionId = branchLogSet.get(0);
                            String message_id = branchLogSet.get(1);
                            ...
                            if ((m % 2) == 0) m++;
                            msgID = m + "";
                        } else if (orig_pin.equals(Constants.PIN_WITHDRAW_WAGE_RESPONSE) && reverse_pin.equals(Constants.PIN_REVERSE_WITHDRAW_WAGE)) {
                            origExist = "1";
//                            extractSessionId();
                            sessionId = branchLogSet.get(0);
                            String message_id = branchLogSet.get(1);
