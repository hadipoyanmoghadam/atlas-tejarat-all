 ...
 * Time: 10:31 AM
 */
public class ConvertorWithdrawATM extends BranchBaseConvertor implements BranchToIMFFormater {
    ...
    public CMCommand format(BranchMessage branchMsg) {
        ...
        command.addParam(Fields.REQUEST_TYPE, branchMsg.getRequestType());
        command.setCommandName(TJCommand.CMD_BRANCH_WITHDRAW_ATM);
        return command;
