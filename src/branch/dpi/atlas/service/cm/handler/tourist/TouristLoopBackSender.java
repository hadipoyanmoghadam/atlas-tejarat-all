 ...
 * Time: 08:52 AM
 */
public class TouristLoopBackSender extends CMHandlerBase implements Connector {
    ...
    public void doProcess(CMMessage msg, Map holder) throws CMFault {
        ...
        if (msg.getAttribute(CMMessage.RESPONSE) != null) {
            try {
                ...
                String touristResponse = msg.getAttributeAsString(CMMessage.RESPONSE);
                source.sendBranch(touristResponse);
            } catch (IOException e) {
                log.error("***  ***" + e);
