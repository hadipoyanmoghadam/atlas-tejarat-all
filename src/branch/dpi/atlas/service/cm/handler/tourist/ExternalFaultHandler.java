    ...
    public void doProcess(CMMessage msg, Map holder)
    {
      if (log.isInfoEnabled()) log.info("Inside ExternalFaultHandler:process()");
        ...
        try {
            ...
            touristMessage.setActionCode(actionCode);
            int msgId = 1;
            ...
            msg.setAttribute(CMMessage.RESPONSE, touristMessage.createResponseHeader());
            ...
            try {
                if (!msg.hasAttribute(CMMessage.RESPONSE)) {
                    ...
                    touristMessage= (TouristMessage) msg.getAttribute(CMMessage.COMMAND_OBJ);
                    touristMessage.setActionCode(ActionCode.CHANNEL_CAN_NOT_CREATE_RESPONSE);
                    msg.setAttribute(CMMessage.RESPONSE, touristMessage.createResponseHeader());
                }
                connector.sendAsyncText(msg);
            } catch (Exception e1) {
