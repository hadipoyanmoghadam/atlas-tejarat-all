 ...
 * Time: 04:55 PM
 */
public class ConvertorTouristCardFundTransfer extends TouristBaseConvertor implements TouristToIMFFormater {
    ...
    public CMCommand format(TouristMessage touristMessage) {
        ...
        command.addParam(Fields.SRC_ACCOUNT, touristMessage.getSrcAccountNo());
        command.addParam(Fields.DEST_ACCOUNT, touristMessage.getDestAccountNo());
        command.addParam(Fields.PAN, Constants.BANKE_TEJARAT_BIN_NEW);
        command.setCommandName(TJCommand.CMD_TOURIST_FUND_TRANSFER);
        return command;
    }
