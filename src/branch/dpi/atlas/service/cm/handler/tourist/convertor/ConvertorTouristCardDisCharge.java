 ...
 * Time: 04:58 PM
 */
public class ConvertorTouristCardDisCharge extends TouristBaseConvertor implements TouristToIMFFormater {
    @Override
    public CMCommand format(TouristMessage touristMessage) {
        ...
        command.setCommandName(TJCommand.CMD_TOURIST_DISCHARGE);
