 ...
 */
public class ConditionalRevokeAccount extends CFSHandlerBase implements Configurable {
    private static Log log = LogFactory.getLog(ConditionalRevokeAccount.class);
    protected String accountField;

    public ConditionalRevokeAccount() {
    ...
    public void doProcess(CMMessage msg, Map holder) throws CFSFault {
        ...
        try {
            ...
            int result=CFSFacadeNew.conditionalRevokeAccount(acc, branchId,nationalCode,externalIdNumber,sessionId,channelType);
