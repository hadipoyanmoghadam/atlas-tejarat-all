...
public class DoTransactionForWage extends CFSHandlerBase implements Configurable {
    ...
    public void doProcess(CMMessage msg, Map holder) throws CFSFault {
        ...
        long origAmount = Long.parseLong((String) msg.getAttribute(Fields.ORIG_AMOUNT));
...
//        String txSrc = (String) msg.getAttribute(Fields.SERVICE_TYPE);
        String txSrc = Constants.BRANCH_WAGE_SERVICE;
        ...
        try {
            ...
            CFSFacadeNew.txnGetWageTransaction(tx, balanceMinimum,origAmount);
            ...
            log.error(e);
            throw new CFSFault(CFSFault.FAULT_NO_ACCOUNT_OF_TYPE_REQUESTED, ActionCode.NO_ACCOUNT_OF_TYPE_REQUESTED);
