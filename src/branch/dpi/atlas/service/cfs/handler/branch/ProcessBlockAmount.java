 ...
 */
public class ProcessBlockAmount extends CFSHandlerBase implements Configurable {
    private static Log log = LogFactory.getLog(ProcessBlockAmount.class);
    protected String accountField;
    protected String amountField;

    public ProcessBlockAmount() {
    ...
    public void doProcess(CMMessage msg, Map holder) throws CFSFault {
        ...
        try {
            ...
            log.error("Can not zeropad account number = '" + acc + "' in ProcessBlockAmount : " + e.getMessage());
        }
        try {
            long minBlance = 0;
            ...
            if(documentStatus==null)
                documentStatus="";
            boolean havingDocument=CFSFacadeNew.doBlockAmountTransactional(acc, minBlance, blockedAmount, blockNo, brokerId,proverId,chnUser, branchId,
                    documentDescribtion, createDate, createTime,accountStatus,blockDate,blockTime,tx,documentStatus);
