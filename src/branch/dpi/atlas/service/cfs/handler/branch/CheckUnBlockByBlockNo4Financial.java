 ...
 */
public class CheckUnBlockByBlockNo4Financial extends CFSHandlerBase implements Configurable {

    private static Log log = LogFactory.getLog(CheckUnBlockByBlockNo4Financial.class);
    protected String accountField;
    protected String amountField;

    public CheckUnBlockByBlockNo4Financial() {
    ...
    public void doProcess(CMMessage msg, Map holder) throws CFSFault {
        ...
        try {
            ...
            log.error("Can not zeropad account number = '" + acc + "' in CheckUnBlockByBlockNo4Financial : " + e.getMessage());
        }
        try {
