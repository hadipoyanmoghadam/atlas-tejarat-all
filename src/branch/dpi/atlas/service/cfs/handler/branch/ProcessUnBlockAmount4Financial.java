 ...
 */
public class ProcessUnBlockAmount4Financial extends CFSHandlerBase implements Configurable {
    private static Log log = LogFactory.getLog(ProcessUnBlockAmount4Financial.class);
    protected String accountField;
    protected String amountField;

    public ProcessUnBlockAmount4Financial() {
    ...
    public void doProcess(CMMessage msg, Map holder) throws CFSFault {
        ...
        try {
            ...
            log.error("Can not zeropad account number = '" + acc + "' in ProcessUnBlockAmount4Financial : " + e.getMessage());
        }
        ...
        try {
            ...
            CFSFacadeNew.doUnBlockAmountTransactional4Financial(acc, blockNo, brokerId, proverId, blockedAmount, branchId, chnUser, "", blockDesc, createDate, createTime, blockDate, blockTime, unBlockDesc);
