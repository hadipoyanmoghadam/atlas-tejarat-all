 ...
 * @version $Revision: 1.0 $ $Date: 2018/09/22 9:10:49 $
 */

public class DoTransaction4DChargeAllCards extends CFSHandlerBase implements Configurable {
    ...
    public void doProcess(CMMessage msg, Map holder) throws CFSFault {
        ...
        try {
            CFSFacadeNew.txnDoDChargeTransaction4AllCards(tx, extraData);
